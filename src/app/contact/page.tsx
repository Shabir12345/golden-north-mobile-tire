          ...
          <dl className="mt-12 grid gap-px overflow-hidden rounded-xl bg-[var(--color-border)] sm:grid-cols-3">
            ...
            <div className="bg-[var(--color-card)] px-6 py-6">
              ...
              <dd className="mt-2">
                <a
                  href={mailHref}
                  className="inline-block py-2 -my-2 text-lg font-bold text-[var(--color-accent-deep)] hover:text-[var(--color-heading)] rounded-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-card)]"
                  aria-label={`Email GoldenNorth at ${BUSINESS.email}`}
                >
                  {BUSINESS.email}
                </a>
              </dd>
