...
GTA drivers in a moment of friction — a flat or seasonal tire, a dead battery, keys
locked in the car, an empty tank, a car that won't start — who need help to come to
*them* rather than driving to a shop.
The defining context is stress and immediacy: many arrive stranded, outdoors, on a
phone, sometimes late at night or in bad weather. A second audience is the planner
booking a seasonal on/off-rim swap or buying tires, who is calmer but still values
"we come to you" convenience.

The job to be done: *get qualified help moving toward me, fast.* The site's success
is measured by the phone call placed, not time on page.

## Product Purpose

The marketing site for **GoldenNorth Mobile Tire Services**, a 24/7 emergency
roadside assistance and mobile vehicle-service business serving the GTA (roadside
assistance, mobile tire service, battery jump starts, car lockouts, mobile mechanic).
It exists to turn a stranded or shopping visitor into a phone call, and to rank for
local intent searches ("roadside assistance Toronto", "car lockout Toronto",
"mobile mechanic Toronto", "mobile tire change Toronto",
"24/7 roadside tire Scarborough"). Replaces the legacy
...
**Clean & Trustworthy** system (white canvas, navy + gold accents, Barlow type with
Barlow Condensed display): approachable and easy to navigate.
...
- **Generic auto-shop sites** — cluttered red/yellow, clip-art tires, stock-photo
  banners, coupon spam.
- **Cheap AI / SaaS templates** — centered hero, a tiny uppercase eyebrow above every
  section, identical icon-cards, cream/sand background, gradient text.
- **Corporate fleet / insurance** — cold, faceless big-company blue with no
  personality.
...
system (white canvas, navy + gold, Barlow), not by importing the visual
...
4. **Distinctive over safe.** Commit to the Clean & Trustworthy identity — white canvas,
   navy + gold, Barlow, soft cards, the north-star mark. Reject category slop
...
6. **Attention is rationed.** Repeating motion is reserved for the three
   conversion anchors (live-dispatch dot, call-button pulse, and the slow ambient
   compass rose); everything else animates once or on hover. The 20–30 minute
   promise is always phrased "in as little as 20–30 minutes."

## Accessibility & Inclusion

Target **WCAG 2.2 AA**: body contrast ≥4.5:1 and large text ≥3:1 (navy-on-gold
verified ≈8:1), visible focus states on all interactive elements, semantic landmarks and
